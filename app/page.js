...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen scroll-smooth bg-[#f7f4ee] text-[#1f1a17]">
     ...
     <p className="mt-5 max-w-lg text-[15px] leading-7 text-[#5f5449] sm:text-lg sm:leading-8 md:max-w-2xl md:text-xl">5449] sm:text-lg sm:leading-8 md:max-w-2xl md:text-xl">
